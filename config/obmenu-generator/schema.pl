...
our $SCHEMA = [
    ...
    {sep => undef},
    {beg => ['Advanced Settings', 'system-run']},

      # Configuration files
      {item => ["$editor ~/.conkyrc",              'Conky RC',    'conky']},
      {item => ["$editor ~/.config/tint2/tint2rc", 'Tint2 Panel', 'text-x-generic']},
      {item => ["$editor ~/.config/picom.conf ", 'Picom', 'picom']},
    ...
    {item => ['shutdown-dialog', 'Shutdown', 'system-shutdown']},
]
